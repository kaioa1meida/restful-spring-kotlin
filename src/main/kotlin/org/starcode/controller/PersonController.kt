...
class PersonController {
    ...
    @Operation(summary = "Finds Persons by Name", description = "Finds a Person by First Name",
        tags = ["People"],
        responses = [
            ApiResponse(description = "Success", responseCode = "200", content = [
                Content(array = ArraySchema(schema = Schema(implementation = PersonVO::class)))
    ...
    fun findPersonByName(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(personService.findPersonByName(firstName, pageable))
    }
